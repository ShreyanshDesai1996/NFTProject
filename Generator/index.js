...
function createImage(idx) {
    ...
    if (face[takenFaces]) {
        ...
        //Ideally the metadata should be stored in a different folder after the ipfs folder (and therefore CID) for the images is generated - 
        //so that the image url in the metadata can point to the IPFS location of the image 
